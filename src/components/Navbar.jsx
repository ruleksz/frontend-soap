    ...
    <nav className="w-full bg-gradient-to-r from-cyan-400 to-orange-400 shadow-md">
      ...
      {menuOpen && (
        <div className="md:hidden bg-cyan-500 text-white px-6 pb-4 space-y-2">
          ...
          <a href="#" className="block hover:text-gray-100">About Us</a>
          <a href="#" className="block hover:text-gray-100">Property Search</a>
          <a href="#" className="block hover:text-gray-100">Article</a>
          <a href="#" className="block hover:text-gray-100">Agent Registration</a>
